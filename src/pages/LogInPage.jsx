      ...
      <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-lg shadow-lg">
        ...
        <div className="mt-6">
          ...
          <div className="mt-6">
            <Link
              to="/signup"
              className="w-full flex items-center justify-center px-4 py-2 border border-brand rounded-md shadow-sm text-sm font-medium text-brand bg-white hover:bg-brand hover:text-white transition-colors duration-200"
            >
              Create new account
            </Link>
          </div>
